                ...
                <div class="col-md-8 col-xl-9">
                    <form id="contact-form" name="contact-form" action="mail.php" method="POST">
                        ...
                        <div class="center-on-small-only">
                            <input type="submit" value="send" name="submit" style="color:white;" class="btn btn-primary">
                            <a class="btn btn-warning" href="\prc\index.php">Back</a>
                        </div>
                    </form>
                </div>
                <!--Grid column-->
